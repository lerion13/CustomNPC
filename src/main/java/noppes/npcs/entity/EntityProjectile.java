   ...
   public void onUpdate() {
      ...
      if(this.field_70193_a) {
         ...
         if(!super.worldObj.isRemote) {
            ...
            if(ff1 != null) {
               movingobjectposition = new MovingObjectPosition(ff1);
            }
            ...
            if(this.npc != null && movingobjectposition != null && movingobjectposition.entityHit != null && movingobjectposition.entityHit instanceof EntityPlayer) {
               ...
               if(this.npc.faction.isFriendlyToPlayer(var26)) {
         ...
         if(this.isRotating()) {
            int var23 = this.isBlock()?10:20;
            super.rotationPitch -= (float)(this.field_70195_i % 15 * var23) * this.getSpeed();
         }
         ...
         if(this.isInWater()) {
            if(super.worldObj.isRemote) {
               for(int var24 = 0; var24 < 4; ++var24) {
                  float var25 = 0.25F;
                  super.worldObj.spawnParticle("bubble", super.posX - super.motionX * (double)var25, super.posY - super.motionY * (double)var25, super.posZ - super.motionZ * (double)var25, super.motionX, super.motionY, super.motionZ);
               }
            }
         ...
         super.motionX *= (double)var22;
         super.motionY *= (double)var22;
         super.motionZ *= (double)var22;
         if(this.hasGravity()) {
      ...
      if(movingobjectposition.entityHit != null) {
         ...
         if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), axisalignedbb)) {
            ...
            if(this.punch > 0) {
               ...
               if(var15 > 0.0F) {
                  movingobjectposition.entityHit.addVelocity(super.motionX * (double)this.punch * 0.6000000238418579D / (double)var15, 0.1D, super.motionZ * (double)this.punch * 0.6000000238418579D / (double)var15);
               }
            }
            ...
            if(this.effect != EnumPotionType.None && movingobjectposition.entityHit instanceof EntityLivingBase) {
               if(this.effect != EnumPotionType.Fire) {
                  var13 = this.getPotionEffect(this.effect);
                  ((EntityLivingBase)movingobjectposition.entityHit).addPotionEffect(new PotionEffect(var13, this.duration * 20, this.amplify));
               } else {
      ...
      if(this.explosive) {
         ...
         if(this.explosiveRadius == 0 && this.effect != EnumPotionType.None) {
            if(this.effect == EnumPotionType.Fire) {
               ...
               var13 = movingobjectposition.blockY;
               int var16 = movingobjectposition.blockZ;
               ...
               if(super.worldObj.isAirBlock(var12, var13, var16)) {
                  super.worldObj.setBlock(var12, var13, var16, Blocks.fire);
               }
            } else {
               AxisAlignedBB var19 = super.boundingBox.expand(4.0D, 2.0D, 4.0D);
               List var20 = super.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, var19);
               if(var20 != null && !var20.isEmpty()) {
                  iterator = var20.iterator();

                  while(iterator.hasNext()) {
                     EntityLivingBase var18 = (EntityLivingBase)iterator.next();
                     double d0 = this.getDistanceSqToEntity(var18);
                     if(d0 < 16.0D) {
                        double d1 = 1.0D - Math.sqrt(d0) / 4.0D;
                        if(var18 == movingobjectposition.entityHit) {
                           d1 = 1.0D;
                        }

                        int i = this.getPotionEffect(this.effect);
                        if(Potion.potionTypes[i].isInstant()) {
                           Potion.potionTypes[i].affectEntity(this.getThrower(), var18, this.amplify, d1);
                        } else {
                           int j = (int)(d1 * (double)this.duration + 0.5D);
                           if(j > 20) {
                              var18.addPotionEffect(new PotionEffect(i, j, this.amplify));
                           }
                        }
                     }
                  }
            ...
            boolean var14 = super.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing") && this.explosiveDamage;
